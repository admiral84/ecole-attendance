...
export default function AttendanceClient() {
  ...
  const fetchAbsentStudentsByClass = async (classId) => {
    ...
    if (result.success) {
      ...
      const studentsWithNotifStatus = filteredStudents.map((student) => ({
        ...
        hasNotification:
          !!notifMap?.[
            `${student.id_eleve}-${student.absence_start_date}`
          ],
      }));
  ...
  return (
    <div
      className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-gray-100 py-4 sm:py-8 px-2 sm:px-4"
      dir="rtl"
    >
                ...
                {allAbsentStudents.count === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 text-lg">
                      لا يوجد تلاميذ غائبين
                    </p>
                    <p className="text-gray-400 text-sm mt-2">
                      جميع التلاميذ حاضرون
                    </p>
                  </div>
                ) : (
                  Object.entries(allAbsentStudents.grouped).map(
                    ([className, students]) => (
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                              {students.map((student, index) => (
                                ...
                                >
                                  ...
                                  <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {student.class_libelle}
                                  </td>
                                  <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    {formatDate(student.absence_start_date)}
                                  </td>
                                  <td className="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                ...
                <div className="overflow-x-auto">
                  {absentStudents.length === 0 ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-400 text-sm mt-2">
                        جميع التلاميذ حاضرون في هذا القسم
                      </p>
                    </div>
                  ) : (
                    <table className="min-w-full divide-y divide-gray-200">
                          ...
                          >
                            ...
                            <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                              <div className="flex gap-2 flex-wrap">
                                ...
                                <button
                                  onClick={() =>
                                    handleViewAbsenceDetails(student)
                                  }
            ...
            <div className="space-y-4">
              <div className="border-b pb-3">
                ...
                <p className="text-lg font-semibold">
                  {selectedAbsence.student_name || selectedAbsence.nom}
                </p>
              </div>
              ...
              <div className="border-b pb-3">
                ...
                <p className="text-lg">
                  {selectedAbsence.class_libelle || selectedStudentClass}
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 border-b pb-3">
                <div>
                  ...
                  <p className="text-lg">
                    {formatDate(selectedAbsence.absence_start_date)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">وقت بدء الغياب</p>
                  <p className="text-lg">
                    {selectedAbsence.absence_start_time || "—"}
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 border-b pb-3">
                <div>
                  ...
                  <p className="text-lg">
                    {formatDate(selectedAbsence.absence_end_date)}
                  </p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">وقت العودة</p>
                  <p className="text-lg">
                    {selectedAbsence.absence_end_time || "—"}
                  </p>
                </div>
              </div>
