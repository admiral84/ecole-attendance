...
export async function createClass(classData) {
  try {
    ...
    if (userData.role !== "admin" && userData.role !== "manager") {
      return {
        success: false,
        error: "غير مصرح به. فقط المديرين يمكنهم إضافة أقسام",
      };
    }
...
export async function updateClass(classId, classData) {
  try {
    ...
    if (userData.role !== "admin" && userData.role !== "manager") {
      return {
        success: false,
        error: "غير مصرح به. فقط المديرين يمكنهم تعديل الأقسام",
      };
    }
...
export async function deleteClass(classId) {
  try {
    ...
    if (userData.role !== "admin") {
      return {
        success: false,
        error: "غير مصرح به. فقط المدير يمكنه حذف الأقسام",
      };
    }
    ...
    if (countError) {
      return {
        success: false,
        error: "تعذر التحقق من عدد التلاميذ في القسم",
      };
    }
